...
// Encapsuler le code pour éviter les collisions des noms des variables et pour
// ne pas créer d'effets de bord.
(function() {
     ...
     * fond du cadre et insérant le nom de la personne saluée.
     *
    ...
    // Ajouter la fonction de création dans la variable "mod" de l'application,
    // pour que l'application puisse créer plusieurs instances de ce module. La
    // clé doit correspondre à l'adresse du module.
