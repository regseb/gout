...
(function() {
    ...
    var create = function(id, url) {
        $.getJSON(url + "/config.json").then(function(args) {
            ...
            // Par défaut, mettre à jour une fois par heure entre 14h et 18h ;
            // et une fois à 1h pour effacer le sujet de l'émission de la
            // veille.
            setCron(update, args.cron || "0 1,14-18 * * *", id);
    ...
    app.mod["regseb/cdanslair"] = create;
